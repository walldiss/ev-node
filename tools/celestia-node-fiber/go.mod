module github.com/evstack/ev-node/tools/celestia-node-fiber

go 1.26.1

replace (
	// celestia-node replace directives (copied from its go.mod so we pull the
	// same Celestia forks). Keep this block in sync with
	// github.com/celestiaorg/celestia-node go.mod.
	...
	github.com/consensys/gnark-crypto => github.com/consensys/gnark-crypto v0.18.0
...
// Use the parent ev-node module for block.* types re-exported from
// block/public.go.
