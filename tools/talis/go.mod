module github.com/evstack/ev-node/tools/talis

go 1.26.1

// Replace directives mirror celestia-app/feat/fibre-payments at
// fe8cb867. They are required because celestia-app's own go.mod uses
// celestia-forked SDK / cometbft / IBC modules, and Go's module system
// only honors `replace` directives in the main module — so any module
// that imports celestia-app must repeat them here.
replace (
...
require (
	...
	github.com/celestiaorg/celestia-app/v9 v9.0.0-20260427135040-fe8cb867259e
